  ...
  return (
    <div className="w-full max-w-[1560px] mx-auto space-y-6">
      ...
      <div className="crystal-glass rounded-2xl p-6 shadow-glass flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-[24px] font-bold text-[#0F172A]">My Requests & Tickets</h1>
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-[#0F172A] hover:bg-slate-800 text-white text-[13px] font-semibold transition-all shadow-sm"
        >
      ...
      <div className="crystal-glass rounded-2xl p-4 sm:p-5 shadow-glass space-y-3.5 border border-white">
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          {/* Status Tabs */}
          <div className="flex items-center p-1 rounded-xl bg-white/60 border border-white/80 w-full sm:w-auto overflow-x-auto">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 text-[12px]">
          ...
          <button
            ...
            className={`px-3 py-1 rounded-lg border transition-all ${
              categoryFilter === 'ALL'
                ? 'bg-teal-50 text-[#0D9488] border-teal-200 font-semibold'
      ...
      <div className="crystal-glass rounded-2xl shadow-glass overflow-hidden border border-white">
            ...
            <tbody className="divide-y divide-white/40 text-[#0F172A] text-[13px]">
              {filteredRequests.map((req) => (
                ...
                >
                  ...
                  <td className="py-3.5 px-6 font-medium text-[#0F172A] max-w-sm truncate">
                    {req.subject}
                  </td>
                  ...
                  <td className="py-3.5 px-6 text-slate-600 text-[12px] truncate max-w-[150px]">
                    {req.assignedTo}
                  </td>
                  ...
                  <td className="py-3.5 px-6 text-right">
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1 rounded-lg bg-white/80 hover:bg-white text-[#0F172A] text-[12px] font-semibold border border-white shadow-2xs transition-all"
                    >
